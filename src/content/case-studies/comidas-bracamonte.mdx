...
<ProjectImage
  src="/projects/comidas-bracamonte/plan-and-postal-code.webp"
  alt="Comidas Bracamonte subscription plan selector with postal-code configuration."
  caption="The purchase flow starts with the service plan and postal code, which drive pricing and location-specific rules."
  width={1600}
  height={1022}
/>
...
<ProjectImage
  src="/projects/comidas-bracamonte/weekly-menu-selection.webp"
  alt="Weekly meal-selection interface for a Comidas Bracamonte subscription."
  caption="Customers configure dishes across the subscription cycle, with recommended selections available to reduce manual choices."
  width={1600}
  height={758}
/>
...
<ProjectImage
  src="/projects/comidas-bracamonte/strapi-content-manager.webp"
  alt="Strapi Content Manager used to operate Comidas Bracamonte."
  caption="Operational content and business configuration are managed through Strapi rather than being hardcoded into the frontend."
  width={1600}
  height={764}
/>

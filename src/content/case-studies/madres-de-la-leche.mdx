...
<ProjectImage
  src="/projects/madres-de-la-leche/digital-member-id-redacted.webp"
  alt="Redacted digital membership card in the Madres de la Leche platform."
  caption="Members receive a digital identifier they can present when accessing benefits from participating businesses."
  width={1600}
  height={912}
/>
...
<ProjectImage
  src="/projects/madres-de-la-leche/event-detail.webp"
  alt="Public Madres de la Leche event detail page."
  caption="Events are published through the CMS and presented as part of the association's public and membership workflows."
  width={1137}
  height={1480}
/>
...
<ProjectImage
  src="/projects/madres-de-la-leche/email-template-editor.webp"
  alt="Visual email-template editor integrated into the Payload administration interface."
  caption="A custom email-template workflow lets the association edit transactional communication while preserving dynamic application values."
  width={1600}
  height={1157}
/>
...
<ProjectImage
  src="/projects/madres-de-la-leche/leaflet-location-field.webp"
  alt="Custom Leaflet map field embedded in the Payload administration interface."
  caption="I built a custom Leaflet and OpenStreetMap field so administrators can manage physical locations directly from Payload."
  width={1600}
  height={1085}
/>
